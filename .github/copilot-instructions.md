...
- **Title:** Airfi
- **Class prefix:** `Airfi`
- **Main code:** `custom_components/airfi/`
...
- `entity/` — Base entity class (`AirfiEntity`)
...
- Entity MRO: `(PlatformEntity, AirfiEntity)` — order matters
...
- Debug level: `custom_components.airfi: debug` in `config/configuration.yaml`

...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Airfi`
...
- Inherit from both platform entity and `AirfiEntity` (order matters)
...
from custom_components.airfi.sensor import async_setup_entry
...
**Config entry data:** `entry_data: AirfiData = hass.data[DOMAIN][entry.entry_id]`

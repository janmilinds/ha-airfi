...
from .[entity_file] import Airfi[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: AirfiDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            Airfi[EntityName](coordinator, entry),
...
- [ ] Entity class inherits from both `AirfiEntity` and platform class
...
- **Domain:** `airfi`
- **Class prefix:** `Airfi`
- **Base entity:** `AirfiEntity` in `entity/base.py`
- **Coordinator:** `AirfiDataUpdateCoordinator`

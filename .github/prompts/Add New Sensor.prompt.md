...
- Entity: `custom_components/airfi/sensor/[sensor_name].py`
- Platform: `custom_components/airfi/sensor/__init__.py`
- Translations: `custom_components/airfi/translations/*.json`

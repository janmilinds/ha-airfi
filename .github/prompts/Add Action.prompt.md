...
**File:** `custom_components/airfi/services.yaml`
...
Create `custom_components/airfi/service_actions/[action_name].py`:

```python
"""[Action name] service action for Airfi."""
...
**File:** `custom_components/airfi/__init__.py`
...
**File:** `custom_components/airfi/const.py`
...
3. Find service action: `airfi.[action_name]`
...
- **Domain:** `airfi`
- **Service actions directory:** `custom_components/airfi/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/airfi/services.yaml` (legacy filename)
- **Icons:** `custom_components/airfi/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/airfi/translations/*.json` under `services` key (legacy)

...
from custom_components.airfi.config_flow_handler.schemas import get_options_schema
from homeassistant import config_entries


class AirfiOptionsFlow(config_entries.OptionsFlow):
    """
